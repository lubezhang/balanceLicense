...
//            str1 = RSACoder.encryptByPublicKey(str);
            System.out.println("种子——私钥加密："+RSACoder.encryptByPrivateKey(seed));
            System.out.println("PID——私钥加密："+RSACoder.encryptByPrivateKey(pid));
            System.out.println("超级用户PID——私钥加密："+RSACoder.encryptByPrivateKey(soPIn));
            System.out.println("普通用户PID——私钥加密："+RSACoder.encryptByPrivateKey(userPin));
